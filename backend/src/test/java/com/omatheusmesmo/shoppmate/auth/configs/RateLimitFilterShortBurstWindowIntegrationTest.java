...
@TestPropertySource(properties = {
        ...
        "security.rate-limit.refill-tokens=100",
        "security.rate-limit.refill-duration=1m",

        // Short burst window: this is what this test is proving.
        "security.rate-limit.short-burst-enabled=true",
        "security.rate-limit.short-burst-capacity=2",
        "security.rate-limit.short-burst-refill-tokens=2",
        "security.rate-limit.short-burst-refill-duration=500ms",
